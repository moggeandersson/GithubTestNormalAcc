...
func main() {
	...
	close(ch) // Close the channel and then let consumers finish since there won't be anything new for Consumers to consume.
	wgc.Wait() //Wait untill consumers finish.
